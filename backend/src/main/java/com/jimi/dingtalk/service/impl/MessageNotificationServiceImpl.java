...
import com.jimi.dingtalk.enums.MsgTypeEnum;
import com.jimi.dingtalk.exception.InvokeDingTalkException;
import com.jimi.dingtalk.model.*;
...
//    private AppConfig appConfig;
    ...
    public Long sendWorkNotice(DingTalkWorkNoticeInputVO dingTalkWorkNoticeInputVO) {
        DingAppInfo dingAppInfo = DingAppConfigUtil.getDingAppInfo(dingTalkWorkNoticeInputVO.getDingAppCode());
        String accessToken = AccessTokenUtil.getAccessToken(dingAppInfo.getAppKey(), dingAppInfo.getAppSecret());
    ...
    public String sendGroupMessage(GroupMessageInputVO groupMessageInputVO) {
        DingAppInfo dingAppInfo = DingAppConfigUtil.getDingAppInfo(groupMessageInputVO.getDingAppCode());
        log.info("MessageNotificationServiceImpl-sendGroupMessage.dingAppInfo:{}", JSONObject.toJSONString(dingAppInfo));
        String accessToken = AccessTokenUtil.getAccessToken(dingAppInfo.getAppKey(), dingAppInfo.getAppSecret());
     ...
     */
    @Override
    public List<String> getReadList(String dingAppCode, String messageId) {
